...
import torch
train_loader = torch.utils.data.DataLoader(tiny_imagenet_dataset_train, batch_size=32, shuffle=True, num_workers=2) # changed num_workers from 8 to 2 because it is suggested by google collab
...
def train(epoch, model, train_loader, criterion, optimizer, device, scheduler):
    model.train()
    running_loss = 0.0
    correct = 0
    total = 0
...
for epoch in range(1, num_epochs + 1):
    train(epoch, model, train_loader, criterion, optimizer, device, scheduler)
