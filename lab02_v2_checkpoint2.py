...
train_loader = DataLoader(tiny_imagenet_dataset_train, batch_size=128, shuffle=True, pin_memory=True, num_workers=4)
val_loader = DataLoader(tiny_imagenet_dataset_val, batch_size=128, shuffle=False, pin_memory=True, num_workers=4)
...
def main():
    ...
    for epoch in range(1, num_epochs + 1):
        train_acc, train_loss = train(epoch, model, train_loader, criterion, optimizer, device, scheduler, verbose=True)

        # At the end of each training iteration, perform a validation step
        val_accuracy, val_loss = validate(model, val_loader, criterion, device, verbose=True)
        ...
        if epoch % 5 == 0:
            torch.save({'epoch': epoch,
                       ...
                       f"checkpoint_{epoch}.pth")  # Save best model
            print(f'Checkpoint saved with Acc={val_accuracy:.2f}%')
        if val_accuracy > best_val_accuracy:
            ...
            torch.save({'epoch': epoch,
                       ...
                       'best_model.pth')  # Save best model
